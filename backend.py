...
def get_users():
   if request.method == 'GET':
      ...
      userToAdd['id'] = ''.join(random.choice(letters) for i in range(6)) # check for duplicate before appending.. todo
      ...
      resp = jsonify(deleteUser.remove()), 200
